 ...
 <meta charset="utf-8">
   ...
   <!-- DataTables CSS -->
    ...
    <![endif]-->
      ...
      <script src="<c:url value='/resources/static/factory/factory.js' />"></script>
      <script src="<c:url value='/resources/static/controller/projectcontroller.js' />"></script>
      <script src="<c:url value='/resources/static/controller/routes.js' />"></script>
</head>
<body>
<div id="wrapper">
